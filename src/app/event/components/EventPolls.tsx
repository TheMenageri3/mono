...
const mockPolls = {
  eventPolls: [
    {
      id: "1",
      question: "Which workshop topic are you most interested in?",
      totalVotes: 156,
      options: [
        { id: "1a", text: "DeFi Protocol Development", votes: 78 },
        { id: "1b", text: "DAO Tooling and Governance", votes: 42 },
        { id: "1c", text: "Smart Contract Security", votes: 36 },
      ],
      hasVoted: true,
      myVote: "1a",
      createdBy: "MTN DAO Team",
    ...
    },
    {
      ...
      endsAt: "2025-01-18T00:00:00Z",
      isActive: true,
    },
    {
      id: "3",
      question: "Would you like to have weekly project demo sessions?",
      totalVotes: 118,
      options: [
        { id: "3a", text: "Yes, definitely", votes: 89 },
        { id: "3b", text: "Maybe, if time permits", votes: 24 },
        { id: "3c", text: "No, prefer to focus on coding", votes: 5 },
      ],
      hasVoted: false,
      createdBy: "MTN DAO Team",
  ...
  friendPolls: [
    {
      id: "4",
      question: "Where should we grab dinner tonight?",
      totalVotes: 8,
      options: [
        { id: "4a", text: "Mountain Kitchen (in house)", votes: 3 },
        { id: "4b", text: "Sushi Bar Downtown (20 min drive)", votes: 4 },
        { id: "4c", text: "Pizza Delivery", votes: 1 },
      ],
      hasVoted: true,
      myVote: "4b",
      createdBy: "Alex Johnson",
      createdAt: "2025-01-21T08:30:00Z",
      endsAt: "2025-01-21T17:30:00Z",
      isActive: true,
      isPrivate: true,
      participants: [
        "Alex Johnson",
    ...
    {
      id: "5",
      question: "Project collaboration interest?",
      totalVotes: 6,
      options: [
        { id: "5a", text: "DeFi dashboard integration", votes: 1 },
        { id: "5b", text: "NFT marketplace feature", votes: 0 },
        { id: "5c", text: "DAO voting mechanism", votes: 5 },
      ],
      hasVoted: false,
      createdBy: "Maya Patel",
      createdAt: "2025-01-20T19:20:00Z",
      endsAt: "2025-01-24T18:00:00Z",
      isActive: true,
      isPrivate: true,
