...
export default function InterestsSelector({
  ...
  const getVisibleCategories = () => {
    return showAllCategories
      ? interestCategories
      : interestCategories.slice(0, 3);
  };
  const handleNext = () => {
    if (selectedInterests.length > 0 && userChoice.experience) {
      onNext({
        interests: selectedInterests,
        experience: userChoice.experience,
      });
    }
  };
      ...
      >
        <div className="text-center mb-12">
          ...
          <p className="text-white/70 text-xl max-w-3xl mx-auto leading-relaxed">
            Select the areas you&apos;d like to explore. We&apos;ll personalize
            your experience based on your choices.
          </p>
        ...
        <div className="space-y-8 mb-8">
          ...
          {!showAllCategories && interestCategories.length > 3 && (
            <motion.div
              initial={{ opacity: 0, y: 20 }}
              animate={{ opacity: 1, y: 0 }}
            ...
            >
              ...
              >
                ...
                Show {interestCategories.length - 3} More Categories
          ...
          {selectedInterests.length > 0 ? (
            ...
            <div className="space-y-4">
              ...
              <p className="text-white/60 text-sm max-w-md mx-auto">
                Choose at least one area that interests you to get personalized
                recommendations
              </p>
            </div>
          )}
